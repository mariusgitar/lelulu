...
const SPILL = [
  ...
  { id: "vannlabben",     emoji: "🔬",  bg: "#D6F0FF", border: "#5BB8F5", shadow: "#1a7bbf",
    ...
    burst: ["⚽","🪨","🍎","🥄","🪵","🪙"] },
  { id: "mysteriet",      emoji: "🐾",  bg: "#E8FFD6", border: "#7DD95A", shadow: "#4caa22",
    label: "Mysteriet",     sublabel: "Hvem gjemmer seg?",     locked: false,
    burst: ["❔","🦶","🐾","🔍","❓","🕵️"] },
  { id: "dyreboka",       emoji: "📖",  bg: "#FFE8F0", border: "#F5A0C0", shadow: "#c4507a",
    label: "Dyreboka",      sublabel: "Lær om dyrene!",        locked: false,
    burst: ["📖","🐘","🦁","📚","🐧","✨"] },
  { id: "sorter",         emoji: "🌊",  bg: "#F0EEFF", border: "#9B8FE8", shadow: "#6254c4",
    label: "Sorter dyrene", sublabel: "Vann, land eller luft?",locked: false,
    burst: ["🐟","🦁","🦉","🦀","🐘","🦜"] },
  { id: "dyreminne",      emoji: "🎵",  bg: "#FFF0E8", border: "#F5A060", shadow: "#c46a20",
